...
var Pc,Qc=Object.freeze(Jc([]));function Rc(a){if(Nc(a))throw Error("Cannot mutate an immutable Message");}
...
function ad(a,b){for(var c=a.slice(),d=0;d<c.length;d++)c[d]=bd(c[d],b);Fc(a)&&Jc(c);return c}
...
function fd(a,b,c,d){c=void 0===c?!0:c;var e=ed(a,b,d);Array.isArray(e)||(e=Qc);if(Nc(a))c&&(Lc(e),Object.freeze(e));else if(e===Qc||Kc(e))e=Jc(e.slice()),F(a,b,e,d);return e}
...
function ld(a,b,c,d){Rc(a);if(null!=d){var e=Jc([]);for(var f=!1,g=0;g<d.length;g++)e[g]=Wc(d[g],b).D,f=f||Kc(e[g]);a.i||(a.i={});a.i[c]=d;Mc(e,!f)}else a.i&&(a.i[c]=void 0),e=Qc;return F(a,c,e)}
...
function Pf(){this.next=this.context=this.onRejected=this.j=this.i=null;this.l=!1}
Pf.prototype.reset=function(){this.context=this.onRejected=this.j=this.i=null;this.l=!1};
var mg=new gf(function(){return new Pf},function(a){a.reset()});
...
353,354,355,356,357,358,361,363,364,368,369,370,373,374,375,378,380,381,388,389,403,410,412,429,413,414,415,416,417,418,430,423,424,425,426,427,431,117];function vh(a){I.call(this,a)}
...
function Wm(a,b){Um();if("log_event"===a.endpoint){Xm(a);var c=Ym(a),d=Pm.get(c)||[];Pm.set(c,d);d.push(a.payload);Zm(b,d,c)}}
function $m(a,b){Um();if("log_event"===a.endpoint){Xm(void 0,a);var c=Ym(a,!0);if(O("jspb_with_transport_leader")&&Jm){var d=Qm.get(c)||[];Qm.set(c,d);Gm.ytExports.logging.transport.leaderQueueLength++;d.push(a.payload);Zm(b,d,c,!0)}else d=Rm.get(c)||[],Rm.set(c,d),a=a.payload.toJSON(),d.push(a),Zm(b,d,c,!0)}}
function Zm(a,b,c,d){d=void 0===d?!1:d;a&&(Km=new a);a=fi("tvhtml5_logging_max_batch")||fi("web_logging_max_batch")||100;var e=Q(),f=d?Nm.l:Mm.l,g=Rm.get(c)||[];O("jspb_with_transport_leader")&&(Jm&&b.length+g.length>=a||!Jm&&Gm.ytExports.logging.transport.leaderQueueLength+b.length>=a)||b.length>=a?Vm({writeThenSend:!0},O("flush_only_full_queue")?c:void 0,d):10<=e-f&&(an(d),d?Nm.l=e:Mm.l=e)}
function bn(a,b){Um();if("log_event"===a.endpoint){Xm(a);var c=Ym(a),d=new Map;d.set(c,[a.payload]);b&&(Km=new b);return new Nf(function(e,f){Km&&Km.isReady()?cn(d,e,f,{bypassNetworkless:!0},!0):e()})}}
function dn(a,b){Um();if("log_event"===a.endpoint){Xm(void 0,a);var c=Ym(a,!0),d=new Map,e=new Map;O("jspb_with_transport_leader")&&Jm?e.set(c,[a.payload]):d.set(c,[a.payload.toJSON()]);b&&(Km=new b);return new Nf(function(f){Km&&Km.isReady()?en(d,e,f,{bypassNetworkless:!0},!0):f()})}}
...
function Vm(a,b,c){a=void 0===a?{}:a;c=void 0===c?!1:c;new Nf(function(d,e){c?(window.clearTimeout(Nm.j),window.clearTimeout(Nm.i),Nm.i=0):(window.clearTimeout(Mm.j),window.clearTimeout(Mm.i),Mm.i=0);if(O("jspb_with_transport_leader")&&!Jm)document.dispatchEvent(new CustomEvent("FLUSH_REQUEST")),d();else if(Km&&Km.isReady())if(void 0!==b)if(c){e=new Map;var f=new Map,g=Rm.get(b)||[];e.set(b,g);O("jspb_with_transport_leader")&&(g=Qm.get(b)||[],f.set(b,g));en(e,f,d,a);O("jspb_with_transport_leader")&&
Qm.delete(b);Rm.delete(b)}else f=new Map,g=Pm.get(b)||[],f.set(b,g),cn(f,d,e,a),Pm.delete(b);else c?(en(Rm,Qm,d,a),Rm.clear(),O("jspb_with_transport_leader")&&Qm.clear()):(cn(Pm,d,e,a),Pm.clear());else an(c),d()})}
function an(a){a=void 0===a?!1:a;if(O("web_gel_timeout_cap")&&(!a&&!Mm.i||a&&!Nm.i)){var b=Uh(function(){Vm({writeThenSend:!0},void 0,a)},6E4);
...
function hn(a){O("always_send_and_write")&&(a.writeThenSend=!1)}
function jn(a,b,c,d,e){return{retry:!0,onSuccess:c,onError:d,ab:a,ga:b,Vb:!!e,headers:{},postBodyFormat:"",postBody:""}}
function gn(a,b,c){a.requestTimeMs=String(b);O("unsplit_gel_payloads_in_logs")&&(a.unsplitGelPayloadsInLogs=!0);!c&&(b=N("EVENT_ID"))&&(c=nn(),a.serializedClientEventId={serializedEventId:b,clientCounter:String(c)})}
function mn(a,b,c){F(a,2,b);if(!c&&(b=N("EVENT_ID"))){c=nn();var d=new vh;F(d,1,b);F(d,2,c);H(a,vh,5,d)}}
function nn(){var a=N("BATCH_CLIENT_COUNTER")||0;a||(a=Math.floor(Math.random()*Im/2));a++;a>Im&&(a=1);Eh("BATCH_CLIENT_COUNTER",a);return a}
...
function ln(a,b,c){if(ed(c,1===hd(c,xh)?1:-1))var d=1;else if(c.getPlaylistId())d=2;else return;H(a,wh,4,c);a=id(a,dh,1)||new dh;c=id(a,bh,3)||new bh;var e=new ah;e.setToken(b);F(e,1,d);md(c,12,ah,e);H(a,bh,3,c)}
function kn(a){for(var b=[],c=0;c<a.length;c++)try{b.push(new th(a[c]))}catch(d){Kh(new jj("Transport failed to deserialize "+String(a[c])))}return b}
...
;var on=A.ytLoggingGelSequenceIdObj_||{};C("ytLoggingGelSequenceIdObj_",on);function pn(a){Vm(void 0,void 0,void 0===a?!1:a)}
function qn(a){on[a]=a in on?on[a]+1:0;return on[a]}
;function rn(a,b){var c=void 0===c?{}:c;var d=ym;N("ytLoggingEventsDefaultDisabled",!1)&&(d=null);a:{c=void 0===c?{}:c;if(O("lr_drop_other_and_business_payloads")){if(Am[a]||zm[a])break a}else if(O("lr_drop_other_payloads")&&Am[a])break a;var e={},f=Math.round(c.timestamp||Q());e.eventTimeMs=f<Number.MAX_SAFE_INTEGER?f:0;e[a]=b;a=Bm();e.context={lastActivityMs:String(c.timestamp||!isFinite(a)?-1:a)};O("log_sequence_info_on_gel_web")&&c.ma&&(a=e.context,b=c.ma,b={index:qn(b),groupKey:b},a.sequence=
b,c.rb&&delete on[c.ma]);(c.zb?bn:Wm)({endpoint:"log_event",payload:e,R:c.R,ga:c.ga},d)}}
;var sn=[{Ha:function(a){return"Cannot read property '"+a.key+"'"},
...
xa:{ReferenceError:[{regexp:/(.*) is not defined/,groups:["key"]},{regexp:/Can't find variable: (.*)/,groups:["key"]}]}}];var un={Y:[],W:[{mb:tn,weight:500}]};function tn(a){if("JavaException"===a.name)return!0;a=a.stack;return a.includes("chrome://")||a.includes("chrome-extension://")||a.includes("moz-extension://")}
;function vn(){this.W=[];this.Y=[]}
var wn;function xn(){if(!wn){var a=wn=new vn;a.Y.length=0;a.W.length=0;un.Y&&a.Y.push.apply(a.Y,un.Y);un.W&&a.W.push.apply(a.W,un.W)}return wn}
;var yn=new L;function zn(a){function b(){return a.charCodeAt(d++)}
...
;var En=A.ytLoggingGelSequenceIdObj_||{};C("ytLoggingGelSequenceIdObj_",En);function Fn(a){var b=void 0;b=void 0===b?{}:b;var c=!1;N("ytLoggingEventsDefaultDisabled",!1)&&(c=!0);c=c?null:ym;b=void 0===b?{}:b;var d=Math.round(b.timestamp||Q());F(a,1,d<Number.MAX_SAFE_INTEGER?d:0);var e=Bm();d=new sh;F(d,1,b.timestamp||!isFinite(e)?-1:e);if(O("log_sequence_info_on_gel_web")&&b.ma){e=b.ma;var f=qn(e),g=new rh;F(g,2,f);F(g,1,e);H(d,rh,3,g);b.rb&&delete En[b.ma]}H(a,sh,33,d);(b.zb?dn:$m)({endpoint:"log_event",payload:a,R:b.R,ga:b.ga},c)}
...
;function Nn(){var a;return x(function(b){return(a=ff())?b.return(a.then(function(c){c=qd(c);for(var d=[],e=0,f=0;f<c.length;f++){var g=c.charCodeAt(f);255<g&&(d[e++]=g&255,g>>=8);d[e++]=g}return xc(d,3)})):b.return(Promise.resolve(null))})}
;var On={};function Pn(a){return On[a]||(On[a]=String(a).replace(/\-([a-z])/g,function(b,c){return c.toUpperCase()}))}
;var Qn={},Rn=[],Ag=new L,Sn={};function Tn(){for(var a=u(Rn),b=a.next();!b.done;b=a.next())b=b.value,b()}
...
function Vn(a){Ag.fa.apply(Ag,arguments)}
...
function Yn(a,b,c){Zn||(Zn={},Th(window,"message",function(d){a:{if(d.origin===Xn(a,"host")){try{var e=JSON.parse(d.data)}catch(f){e=void 0;break a}if(d=Zn[e.id])d.u=!0,d.u&&(D(d.v,d.sendMessage,d),d.v.length=0),d.Oa(e)}e=void 0}return e}));
Zn[c]=b}
var Zn=null;var $n=window;function ao(a,b,c){this.m=this.i=this.j=null;this.l=0;this.u=!1;this.v=[];this.o=null;this.J={};if(!a)throw Error("YouTube player element ID required.");this.id=Qa(this);this.C=c;this.setup(a,b)}
...
n.Oa=function(a){bo(this,a.event,a)};
n.addEventListener=function(a,b){var c=b;"string"===typeof b&&(c=function(){window[b].apply(window,arguments)});
if(!c)return this;this.o.subscribe(a,c);co(this,a);return this};
function eo(a,b){b=b.split(".");if(2===b.length){var c=b[1];a.C===b[0]&&co(a,c)}}
n.destroy=function(){this.i&&this.i.id&&(Qn[this.i.id]=null);var a=this.o;a&&"function"==typeof a.dispose&&a.dispose();if(this.m){a=this.i;var b=a.parentNode;b&&b.replaceChild(this.m,a)}else(a=this.i)&&a.parentNode&&a.parentNode.removeChild(a);Zn&&(Zn[this.id]=null);this.j=null;a=this.i;for(var c in lb)lb[c][0]==a&&Rh(c);this.m=this.i=null};
n.Ra=function(){return{}};
function fo(a,b,c){c=c||[];c=Array.prototype.slice.call(c);b={event:"command",func:b,args:c};a.u?a.sendMessage(b):a.v.push(b)}
function bo(a,b,c){a.o.o||(c={target:a,data:c},a.o.fa(b,c),Vn(a.C+"."+b,c))}
...
$n.yt_embedsTokenValue&&(g.embedsTokenValue=encodeURIComponent($n.yt_embedsTokenValue),delete $n.yt_embedsTokenValue);var h=""+Xn(a.j,"host")+("/embed/"+Xn(a.j,"videoId"))+"?"+Tb(g);$n.yt_embedsEnableUaChProbe?Nn().then(function(k){var l=new URL(h),m=Number(l.searchParams.get("reloads"));isNaN(m)&&(m=0);l.searchParams.set("reloads",(m+1).toString());k&&l.searchParams.set("uach",k);l.searchParams.set("uats",Math.floor(window.performance.timeOrigin).toString());k=Bd(l.href).toString();Dd(c,Cd(k));return k}):
$n.yt_embedsEnableIframeSrcWithIntent?Dd(c,Cd(h)):c.src=h;
return c}
n.bb=function(){this.i&&this.i.contentWindow?this.sendMessage({event:"listening"}):window.clearInterval(this.l)};
function ho(a){Yn(a.j,a,a.id);a.l=Vh(a.bb.bind(a));Th(a.i,"load",function(){window.clearInterval(a.l);a.l=Vh(a.bb.bind(a))})}
n.setup=function(a,b){var c=document;if(a="string"===typeof a?c.getElementById(a):a)if(c="iframe"===a.tagName.toLowerCase(),b.host||(b.host=c?Rb(a.src):"https://www.youtube.com"),this.j=new Wn(b),c||(b=go(this,a),this.m=a,(c=a.parentNode)&&c.replaceChild(b,a),a=b),this.i=a,this.i.id||(this.i.id="widget"+Qa(this.i)),Qn[this.i.id]=this,window.postMessage){this.o=new L;ho(this);b=Xn(this.j,"events");for(var d in b)b.hasOwnProperty(d)&&this.addEventListener(d,b[d]);for(var e in Sn)Sn.hasOwnProperty(e)&&
eo(this,e)}};
...
f.level&&(h=f.level);if(O("console_log_js_exceptions")){var k=f,l=[];l.push("Name: "+k.name);l.push("Message: "+k.message);k.hasOwnProperty("params")&&l.push("Error Params: "+JSON.stringify(k.params));k.hasOwnProperty("args")&&l.push("Error args: "+JSON.stringify(k.args));l.push("File name: "+k.fileName);l.push("Stacktrace: "+k.stack);window.console.log(l.join("\n"),k)}if(!(5<=Hn)){var m=void 0,q=void 0,t=f,p=g,y=ee(t),z=y.message||"Unknown Error",G=y.name||"UnknownError",K=y.stack||t.j||"Not available";
if(K.startsWith(G+": "+z)){var M=K.split("\n");M.shift();K=M.join("\n")}var P=y.lineNumber||"Not available",kb=y.fileName||"Not available",uc=K,va=0;if(t.hasOwnProperty("args")&&t.args&&t.args.length)for(var na=0;na<t.args.length&&!(va=Bn(t.args[na],"params."+na,p,va),500<=va);na++);else if(t.hasOwnProperty("params")&&t.params){var Y=t.params;if("object"===typeof t.params)for(q in Y){if(Y[q]){var ba="params."+q,ca=Dn(Y[q]);p[ba]=ca;va+=ba.length+ca.length;if(500<va)break}}else p.params=Dn(Y)}if(Kn.length)for(var X=
0;X<Kn.length&&!(va=Bn(Kn[X],"params.context."+X,p,va),500<=va);X++);navigator.vendor&&!p.hasOwnProperty("vendor")&&(p["device.vendor"]=navigator.vendor);var S={message:z,name:G,lineNumber:P,fileName:kb,stack:uc,params:p,sampleWeight:1},Rj=Number(t.columnNumber);isNaN(Rj)||(S.lineNumber=S.lineNumber+":"+Rj);if("IGNORED"===t.level)m=0;else a:{for(var Sj=xn(),Tj=u(Sj.Y),Qf=Tj.next();!Qf.done;Qf=Tj.next()){var Uj=Qf.value;if(S.message&&S.message.match(Uj.Wb)){m=Uj.weight;break a}}for(var Vj=u(Sj.W),
Rf=Vj.next();!Rf.done;Rf=Vj.next()){var Wj=Rf.value;if(Wj.mb(S)){m=Wj.weight;break a}}m=1}S.sampleWeight=m;for(var Xj=u(sn),Sf=Xj.next();!Sf.done;Sf=Xj.next()){var Tf=Sf.value;if(Tf.xa[S.name])for(var Yj=u(Tf.xa[S.name]),Uf=Yj.next();!Uf.done;Uf=Yj.next()){var Zj=Uf.value,Ld=S.message.match(Zj.regexp);if(Ld){S.params["params.error.original"]=Ld[0];for(var Vf=Zj.groups,ak={},Vb=0;Vb<Vf.length;Vb++)ak[Vf[Vb]]=Ld[Vb+1],S.params["params.error."+Vf[Vb]]=Ld[Vb+1];S.message=Tf.Ha(ak);break}}}S.params||(S.params=
{});var bk=xn();S.params["params.errorServiceSignature"]="msg="+bk.Y.length+"&cb="+bk.W.length;S.params["params.serviceWorker"]="false";A.document&&A.document.querySelectorAll&&(S.params["params.fscripts"]=String(document.querySelectorAll("script:not([nonce])").length));xb("sample").constructor!==wb&&(S.params["params.fconst"]="true");var ra=S;window.yterr&&"function"===typeof window.yterr&&window.yterr(ra);if(0!==ra.sampleWeight&&!Gn.has(ra.message)){if("ERROR"===h){yn.fa("handleError",ra);if(O("record_app_crashed_web")&&
0===Jn&&1===ra.sampleWeight)if(Jn++,O("errors_via_jspb")){var Wf=new qh;F(Wf,1,1);if(!O("report_client_error_with_app_crash_ks")){var ck=new lh;F(ck,1,ra.message);var dk=new mh;H(dk,lh,3,ck);var ek=new nh;H(ek,mh,5,dk);var fk=new oh;H(fk,nh,9,ek);H(Wf,oh,4,fk)}var no=Wf,gk=new th;kd(gk,qh,20,uh,no);Fn(gk)}else{var hk={appCrashType:"APP_CRASH_TYPE_BREAKPAD"};O("report_client_error_with_app_crash_ks")||(hk.systemHealth={crashData:{clientError:{logMessage:{message:ra.message}}}});rn("appCrashed",hk)}In++}else"WARNING"===
h&&yn.fa("handleWarning",ra);if(O("kevlar_gel_error_routing"))a:{var Xf=void 0,Yf=void 0,Gc=h,R=ra;if(O("errors_via_jspb")){if(Mn())Yf=void 0;else{var Wb=new ih;F(Wb,1,R.stack);R.fileName&&F(Wb,4,R.fileName);var Ja=R.lineNumber&&R.lineNumber.split?R.lineNumber.split(":"):[];0!==Ja.length&&(1!==Ja.length||isNaN(Number(Ja[0]))?2!==Ja.length||isNaN(Number(Ja[0]))||isNaN(Number(Ja[1]))||(F(Wb,2,Number(Ja[0])),F(Wb,3,Number(Ja[1]))):F(Wb,2,Number(Ja[0])));var pb=new lh;F(pb,1,R.message);F(pb,3,R.name);
F(pb,6,R.sampleWeight);"ERROR"===Gc?F(pb,2,2):"WARNING"===Gc?F(pb,2,1):F(pb,2,0);var Zf=new jh;F(Zf,1,!0);kd(Zf,ih,3,kh,Wb);var qb=new fh;F(qb,3,window.location.href);for(var ik=N("FEXP_EXPERIMENTS",[]),$f=0;$f<ik.length;$f++){var jk=qb,oo=ik[$f];Rc(jk);fd(jk,5).push(oo)}var ag=Fh();if(!Gh()&&ag)for(var kk=u(Object.keys(ag)),rb=kk.next();!rb.done;rb=kk.next()){var lk=rb.value,bg=new hh;F(bg,1,lk);bg.setValue(String(ag[lk]));md(qb,4,hh,bg)}var cg=R.params;if(cg){var mk=u(Object.keys(cg));for(rb=mk.next();!rb.done;rb=
mk.next()){var nk=rb.value,dg=new hh;F(dg,1,"client."+nk);dg.setValue(String(cg[nk]));md(qb,4,hh,dg)}}var ok=N("SERVER_NAME"),pk=N("SERVER_VERSION");if(ok&&pk){var eg=new hh;F(eg,1,"server.name");eg.setValue(ok);md(qb,4,hh,eg);var fg=new hh;F(fg,1,"server.version");fg.setValue(pk);md(qb,4,hh,fg)}var Md=new mh;H(Md,fh,1,qb);H(Md,jh,2,Zf);H(Md,lh,3,pb);Yf=Md}var qk=Yf;if(!qk)break a;var rk=new th;kd(rk,mh,163,uh,qk);Fn(rk)}else{if(Mn())Xf=void 0;else{var Hc={stackTrace:R.stack};R.fileName&&(Hc.filename=
R.fileName);var Ka=R.lineNumber&&R.lineNumber.split?R.lineNumber.split(":"):[];0!==Ka.length&&(1!==Ka.length||isNaN(Number(Ka[0]))?2!==Ka.length||isNaN(Number(Ka[0]))||isNaN(Number(Ka[1]))||(Hc.lineNumber=Number(Ka[0]),Hc.columnNumber=Number(Ka[1])):Hc.lineNumber=Number(Ka[0]));var gg={level:"ERROR_LEVEL_UNKNOWN",message:R.message,errorClassName:R.name,sampleWeight:R.sampleWeight};"ERROR"===Gc?gg.level="ERROR_LEVEL_ERROR":"WARNING"===Gc&&(gg.level="ERROR_LEVEL_WARNNING");var po={isObfuscated:!0,browserStackInfo:Hc},
Xb={pageUrl:window.location.href,kvPairs:[]};N("FEXP_EXPERIMENTS")&&(Xb.experimentIds=N("FEXP_EXPERIMENTS"));var hg=Fh();if(!Gh()&&hg)for(var sk=u(Object.keys(hg)),sb=sk.next();!sb.done;sb=sk.next()){var tk=sb.value;Xb.kvPairs.push({key:tk,value:String(hg[tk])})}var ig=R.params;if(ig){var uk=u(Object.keys(ig));for(sb=uk.next();!sb.done;sb=uk.next()){var vk=sb.value;Xb.kvPairs.push({key:"client."+vk,value:String(ig[vk])})}}var wk=N("SERVER_NAME"),xk=N("SERVER_VERSION");wk&&xk&&(Xb.kvPairs.push({key:"server.name",
value:wk}),Xb.kvPairs.push({key:"server.version",value:xk}));Xf={errorMetadata:Xb,stackTrace:po,logMessage:gg}}var yk=Xf;if(!yk)break a;rn("clientError",yk)}if("ERROR"===Gc||O("errors_flush_gel_always_killswitch"))O("web_fp_via_jspb")&&pn(!0),pn()}if(!O("suppress_error_204_logging")){var tb=ra,Ic=tb.params||{},$a={urlParams:{a:"logerror",t:"jserror",type:tb.name,msg:tb.message.substr(0,250),line:tb.lineNumber,level:h,"client.name":Ic.name},postParams:{url:N("PAGE_NAME",window.location.href),file:tb.fileName},
method:"POST"};Ic.version&&($a["client.version"]=Ic.version);if($a.postParams){tb.stack&&($a.postParams.stack=tb.stack);for(var zk=u(Object.keys(Ic)),jg=zk.next();!jg.done;jg=zk.next()){var Ak=jg.value;$a.postParams["client."+Ak]=Ic[Ak]}var kg=Fh();if(kg)for(var Bk=u(Object.keys(kg)),lg=Bk.next();!lg.done;lg=Bk.next()){var Ck=lg.value;$a.postParams[Ck]=kg[Ck]}var Dk=N("SERVER_NAME"),Ek=N("SERVER_VERSION");Dk&&Ek&&($a.postParams["server.name"]=Dk,$a.postParams["server.version"]=Ek)}qi(N("ECATCHER_REPORT_HOST",
"")+"/error_204",$a)}try{Gn.add(ra.message)}catch(uo){}Hn++}}}}}else throw Ub;}else console&&console.warn&&console.warn("The YouTube player is not attached to the DOM. API calls should be made after the onReady event. See more: https://developers.google.com/youtube/iframe_api_reference#Events")};function io(a){return(0===a.search("cue")||0===a.search("load"))&&"loadModule"!==a}
function jo(a){return 0===a.search("get")||0===a.search("is")}
;function ko(a,b){ao.call(this,a,Object.assign({title:"video player",videoId:"",width:640,height:360},b||{}),"player");this.N={};this.playerInfo={}}
v(ko,ao);n=ko.prototype;n.Ra=function(){var a=Xn(this.j,"playerVars");if(a){var b={},c;for(c in a)b[c]=a[c];a=b}else a={};window!==window.top&&document.referrer&&(a.widget_referrer=document.referrer.substring(0,256));if(c=Xn(this.j,"embedConfig")){if(Pa(c))try{c=JSON.stringify(c)}catch(d){console.error("Invalid embed config JSON",d)}a.embed_config=c}return a};
n.Oa=function(a){var b=a.event;a=a.info;switch(b){case "apiInfoDelivery":if(Pa(a))for(var c in a)a.hasOwnProperty(c)&&(this.N[c]=a[c]);break;case "infoDelivery":lo(this,a);break;case "initialDelivery":Pa(a)&&(window.clearInterval(this.l),this.playerInfo={},this.N={},mo(this,a.apiInterface),lo(this,a));break;default:bo(this,b,a)}};
function lo(a,b){if(Pa(b))for(var c in b)b.hasOwnProperty(c)&&(a.playerInfo[c]=b[c])}
...
this.N={};fo(this,c,arguments);return this}:jo(c)?this[c]=function(){var d=0;
...
return this})},a)}
n.getVideoEmbedCode=function(){var a=Xn(this.j,"host")+("/embed/"+Xn(this.j,"videoId")),b=Number(Xn(this.j,"width")),c=Number(Xn(this.j,"height"));if(isNaN(b)||isNaN(c))throw Error("Invalid width or height property");b=Math.floor(b);c=Math.floor(c);Gb.test(a)&&(-1!=a.indexOf("&")&&(a=a.replace(Ab,"&amp;")),-1!=a.indexOf("<")&&(a=a.replace(Bb,"&lt;")),-1!=a.indexOf(">")&&(a=a.replace(Cb,"&gt;")),-1!=a.indexOf('"')&&(a=a.replace(Db,"&quot;")),-1!=a.indexOf("'")&&(a=a.replace(Eb,"&#39;")),-1!=a.indexOf("\x00")&&
...
;C("YT.PlayerState.UNSTARTED",-1);C("YT.PlayerState.ENDED",0);C("YT.PlayerState.PLAYING",1);C("YT.PlayerState.PAUSED",2);C("YT.PlayerState.BUFFERING",3);C("YT.PlayerState.CUED",5);C("YT.get",function(a){return Qn[a]});
C("YT.scan",Tn);C("YT.subscribe",function(a,b,c){Ag.subscribe(a,b,c);Sn[a]=!0;for(var d in Qn)Qn.hasOwnProperty(d)&&eo(Qn[d],a)});
